...
WEEKDAYS_LIST = ['all', 'monday', 'tuesday','wednesday','thursday','friday','saturday', 'sunday']

def get_user_input_for_city():
...
def get_filters():
    ...
    """
    print('Hello! I\'m Oluwakemi Busari! Let\'s explore some US bikeshare data!')

    # TO DO: get user input for city (chicago, new york city, washington). HINT: Use a while loop to handle invalid inputs
    city = get_user_input_for_city()

    # TO DO: get user input for month (all, january, february, ... , june)
    month = get_user_input_for_month()

    # TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
    day = get_user_input_for_weekday()
...
def time_stats(df):
    ...
    print("The most common month from the given fitered data is: " + MONTHS_LIST[common_month].title())
